#!/usr/bin/python3
"""Defines unittests models/state.py.
...
class TestState_instantiation(unittest.TestCase):
    """Unittests testing instantiation State class."""
...
class TestState_save(unittest.TestCase):
    """Unittests testing save method  State class."""
...
class TestState_to_dict(unittest.TestCase):
    """Unittests testing to_dict method State class."""
